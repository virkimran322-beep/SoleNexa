...
- New POs can keep a validated size/colour breakdown, and Finished inventory keeps separate planned/finished/dispatched/on-hand balances for each variant. Older POs remain at PO level. Barcode scanning, landed-cost valuation and supplier tax/discount rules require future work or factory policy decisions. Code 39 label preview/printing is available offline for new variant POs.
