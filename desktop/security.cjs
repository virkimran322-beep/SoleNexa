...
const roles = {
  owner: ['*'],
  manager: ['material','material-revise','cost','po','worker','worker-revise','assignment','receipt','scan-receipt','stock','finished','dispatch','department','department-revise','supplier','supplier-revise','purchase','purchase-return','supplier-payment','warehouse','bin','lot','reservation','reservation-release','transfer','stock-count','stock-count-submit','stock-count-approve','stock-count-reject','inspection','inspection-submit','inspection-approve','inspection-reject','correct-event','cancel-assignment','export-csv','whatsapp-share'],
  supervisor: ['assignment','receipt','scan-receipt','inspection','inspection-submit'],
  storekeeper: ['material','material-revise','stock','finished','dispatch','supplier','purchase','purchase-return','warehouse','bin','lot','reservation','reservation-release','transfer','stock-count','stock-count-submit','inspection','inspection-submit','whatsapp-share'],
...
class Security {
  ...
  snapshot() {
    ...
    if(u.role==='worker') {
      ...
      for(const key of ['material','cost','po','poCosts','poMaterialUsage','worker','assignment','department','events','warehouse','bin','lot','reservation','transfer','stock-count','inventory-close','inspection','supplier','purchase']) s[key]=[];
